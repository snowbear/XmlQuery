...
namespace XmlQuery.Core.Tests.DataParsers.JsonDataParserTests
{
    public class when_json_has_int_attribute : JsonDataParserTestsBase
    {
        ...
        It should_parse_attribute_with_correct_type = () => _result.FirstChild().ShouldBeOfType(typeof(Attribute<int>));
        It should_parse_attribute_with_correct_value = () => _result.FirstChild().Cast<Attribute<int>>().Value.ShouldEqual(5);
    }
}