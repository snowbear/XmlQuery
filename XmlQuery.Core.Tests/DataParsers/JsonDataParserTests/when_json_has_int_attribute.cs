...
{
    public class when_json_has_int_attribute : JsonDataParserTestsBase
    {
        ...
        It should_parse_attribute_with_correct_type = () => _result.FirstChild().ShouldBeOfType(typeof(DataAttribute<int>));
        It should_parse_attribute_with_correct_value = () => _result.FirstChild().Cast<DataAttribute<int>>().Value.ShouldEqual(5);
    }
}